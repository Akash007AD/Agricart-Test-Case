...
export default function Categories() {
    ...
    const productsPerPage = currentPage === 1 ? 15 : 9; // 15 products on page 1, 9 on others
            ...
            fetch(`http://localhost:3026/api/v1/stocks/${category}`)
                ...
                .then((data) => {
                    ...
                    if (Array.isArray(data)) {
                        setProducts(data); // Data is an array of products
                    } else {
    ...
    const totalPages = Math.ceil((products.length - 15) / 9) + 1; // Calculate total number of pages
